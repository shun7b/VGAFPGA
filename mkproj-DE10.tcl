...
#set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to preset 
set_location_assignment PIN_N5 -to ADC_CLK_10
set_location_assignment PIN_P11 -to m_clock 
#set_location_assignment PIN_N14 -to p_reset 
...
# KEY
#============================================================
set_instance_assignment -name IO_STANDARD "3.3 V SCHMITT TRIGGER" -to p_reset 
#set_instance_assignment -name IO_STANDARD "3.3 V SCHMITT TRIGGER" -to m_clock 
set_location_assignment PIN_B8 -to p_reset
#set_location_assignment PIN_A7 -to m_clock
...
set_instance_assignment -name SLEW_RATE 0 -to PIN_A8
set_instance_assignment -name SLEW_RATE 0 -to PIN_A9
set_instance_assignment -name SLEW_RATE 0 -to PIN_A10
set_instance_assignment -name SLEW_RATE 0 -to PIN_B10
set_instance_assignment -name SLEW_RATE 0 -to PIN_D13
set_instance_assignment -name SLEW_RATE 0 -to PIN_C13
set_instance_assignment -name SLEW_RATE 0 -to PIN_E14
set_instance_assignment -name SLEW_RATE 0 -to PIN_D14
set_instance_assignment -name SLEW_RATE 0 -to PIN_A11
set_instance_assignment -name SLEW_RATE 0 -to PIN_B11
set_location_assignment PIN_A8 -to r
set_location_assignment PIN_A9 -to o
set_location_assignment PIN_A10 -to x
set_location_assignment PIN_B10 -to n
